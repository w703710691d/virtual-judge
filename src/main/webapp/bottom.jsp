...
<div style="text-align:center;margin-top:30px;clear:both;font-size:80%">
	<hr />FAQ | About Virtual Judge | <a href="https://github.com/xudianc/virtual-judge" target="_blank">Forum</a> | <a href="${contextPath}/discuss.action" target="_blank">Discuss</a> | <a href="https://github.com/xudianc/virtual-judge" target="_blank">Open Source Project</a><br />
	All Copyright Reserved ©2010-2017 <a href="http://acm.wust.edu.cn">HUST ACM/ICPC</a> TEAM
